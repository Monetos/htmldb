  ...
  return (
    ...
    >
      <div
        ...
        className="flex h-[90vh] w-full max-w-xl flex-col rounded-t-2xl bg-white p-4 dark:bg-slate-900 sm:rounded-2xl"
      >
          ...
          {filtered.map((ex) => (
            <li key={ex.id}>
              <button
                ...
                className="w-full rounded-2xl border border-slate-200 bg-white p-3 text-left hover:border-brand-500 dark:border-slate-700 dark:bg-slate-800/60 dark:hover:border-brand-500"
              >
